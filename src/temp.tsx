...
const Steps: FC<FlexProps> = ({ children, ...props }) => {
...
const StepperContent: FC<BoxProps> = ({ children, ...rest }) => {
  return (
...
const StepperBody: FC<PropsWithChildren & { show: boolean }> = ({
  children,
  show,
}) => {
